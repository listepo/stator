...
static const JSRTClass EMPTY = {"Empty", 0, empty_fields, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const p_fields[] = {"x", "y"};
static const JSRTClass P = {"P", 2, p_fields, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const one_field[] = {"v"};
static const JSRTClass DEEP = {"Deep", 1, one_field, NULL, 0, NULL, NULL, NULL, NULL};
...
static const JSRTClass SHORT = {"S", 1, one_field, NULL, 0, NULL, NULL, NULL, NULL};
static const JSRTClass LONG = {"AVeryLongClassNameIndeed", 1, one_field, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const wide_fields[] = {"field0", "field1", "field2", "field3",
                                          "field4", "field5", "field6", "field7"};
static const JSRTClass WIDE = {"Wide", 8, wide_fields, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const two_long[] = {"averyveryverylongfieldname", "another"};
static const JSRTClass LONGFIELDS = {"Long", 2, two_long, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const mixed_fields[] = {"arr", "o"};
static const JSRTClass N = {"N", 2, mixed_fields, NULL, 0, NULL, NULL, NULL, NULL};
...
static const JSRTClass PRIV = {"Priv", 2, priv_fields, NULL, 0, NULL, NULL, NULL, NULL};

static const char *const all_priv_fields[] = {"#a", "#b"};
static const JSRTClass ALLPRIV = {"AllPriv", 2, all_priv_fields, NULL, 0, NULL, NULL, NULL, NULL};
