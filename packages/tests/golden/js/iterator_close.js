// `for...of` calls IteratorClose on abrupt exit (plan.md §8 step 34), untyped spelling:
// a `break`, `return` or `throw` out of the body runs the iterator's `return()` — a
// generator's `finally`. `continue` does not close, and a stored iterator keeps yielding
