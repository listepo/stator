// Inline generic arrows and function expressions (plan.md §8 step 12(f)): passed
// directly as a call argument, each specializes at the parameter's function type under a
// position-derived key. Must match Node byte-for-byte.
