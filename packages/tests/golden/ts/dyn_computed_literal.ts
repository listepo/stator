...
const om = { x: 10, [k]: 2, m(a: number): number { return this.x + a; } };
console.log(om.m(5));
console.log(om.dyn);
console.log(om.x);
...
function combo(key: string): void {
  const oc = { a: 1, [key]: 2, m(): number { return this.a + 100; }, get g(): number { return this.a + 1000; }, b: 3 };
  console.log(oc.m());
  console.log(oc.g);
