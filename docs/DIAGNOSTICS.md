...
| `STA2xxx` | Lowering / boundary errors | error, runtime | Cast failures and unimplemented lowering operations are compile-time `error`; boundary-check failures are class `runtime`, raised by the emitted program rather than the compiler (`STA2001`, `STA2002`, `STA2004`, `STA2006`) |
