...
// Exceptions cross call frames: the throw is three frames down, the catch at the top. Unlike the
// ts fixture, each level takes a number: an always-throwing untyped function infers `void`, and
// `void + 1` is an error even in js mode -- the conditional keeps the inferred type `number`.
function level3(n) {
  if (n < 10) {
    throw "deep";
  }
